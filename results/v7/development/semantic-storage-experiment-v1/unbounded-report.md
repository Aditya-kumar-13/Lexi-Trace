...
|---|---:|---:|---:|---:|
| sparse_ablation | 12.5% | 12.5% | 0 | 6.357 ms |
| hybrid | 100.0% | 100.0% | 0 | 145.770 ms |
...
- Embedding calls: **26**
- Embedded input characters: **1512**
- Hosted requests: **0**
- Estimated API cost: **$0.00**
- Peak allocated SQLite bytes: **626688**
- Peak vector payload bytes: **145419**
