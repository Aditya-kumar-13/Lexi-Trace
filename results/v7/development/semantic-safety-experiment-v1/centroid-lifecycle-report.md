...
|---|---:|---:|---:|---:|
| sparse_ablation | 61.5% | 30.8% | 0 | 5.471 ms |
| hybrid | 69.2% | 69.2% | 1 | 100.895 ms |
...
- Hosted requests: **0**
- Estimated API cost: **$0.00**
- Peak allocated SQLite bytes: **364544**
...
| kivi-negative-feedback-neighborhood | Add sliced kiwi to the breakfast recipe for more vitamin C. | Add sliced kiwi to the breakfast recipe for more vitamin C. | suggest | abstain |
| kivi-negative-feedback-neighborhood | Inspect the Kivi service rollout with engineering. | Inspect the Kiwi service rollout with engineering. | apply | suggest |
| kivi-negative-feedback-neighborhood | Prepare the Kivi enterprise product campaign for launch. | Prepare the Kiwi enterprise product campaign for launch. | apply | suggest |
| kivi-negative-feedback-neighborhood | Check the Kivi trademark language in the software contract. | Check the Kiwi trademark language in the software contract. | apply | suggest |
| kiwi-overlapping-memory-collision | Discuss the Kiwi update at tomorrow's meeting. | Discuss the Kivi update at tomorrow's meeting. | suggest | apply |
